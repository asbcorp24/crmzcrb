...
class StaffingPosition extends Model
{
    ...
    protected $fillable = ['organization_id','department_id','position_id','planned_rate','note','is_active'];
    ...
    public function getOccupiedRateAttribute(): float { return (float)$this->activeAssignments()->sum('rate'); }
    public function getVacantRateAttribute(): float { return max(0,round((float)$this->planned_rate-$this->occupied_rate,2)); }
}
