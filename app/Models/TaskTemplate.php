...
{
    protected $fillable = ['created_by','assigned_to','title','description','priority','due_after_days','recurrence','recurrence_interval','weekday','day_of_month','next_run_at','is_active'];
