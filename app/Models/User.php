...
class User extends Authenticatable
{
    ...
    protected $fillable = ['department_id','manager_id','last_name','first_name','middle_name','position','email','phone','role','is_active','employment_date','password'];
    protected $hidden = ['password','remember_token'];
    protected $casts = ['is_active'=>'boolean','employment_date'=>'date','email_verified_at'=>'datetime'];
