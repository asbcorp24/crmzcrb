...
class User extends Authenticatable
{
    ...
    protected $fillable = ['organization_id','department_id','manager_id','last_name','first_name','middle_name','position','email','phone','role','is_superadmin','is_active','employment_date','password','admin_password','ui_theme','archived_at','archived_by'];
